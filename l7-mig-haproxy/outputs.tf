...
#output "neo4j_lb7_browser_url" {
#  description = "Neo4j Browser URL"
#  value = "http://${google_compute_global_forwarding_rule.neo4j-lb7-forwarding-rule.ip_address}:80"
#  depends_on = [
#    google_compute_global_forwarding_rule.neo4j-lb7-forwarding-rule
#  ]
#}

#output "neo4j_haproxy_browser_url" {
#  description = "Neo4j Browser URL"
#  value = "http://${google_compute_instance.neo4j-haproxy-jsh.nat_ip}:80"
#}
